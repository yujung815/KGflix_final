...
if (result == 'error') {
	...
	<section>
		...
		<table style="margin-left: auto; margin-right: auto;">
			...
			<tr><th><video autoplay controls src="${cvo.video_uri}" style="width: 40%;"></video></th></tr>
		</table>
		</article>
		<br /><br /><br />
		<article>
			...
			<table style="width: 60%; margin-left: auto; margin-right: auto;">
				<tr>
					<th style="color: white;">&nbsp;&nbsp;&nbsp;&nbsp;asw0711</th> <!-- 로그인 유저 아이디 출력 -->
					...
					<input type="hidden" name="id" value="asw0711" /> <!-- 로그인정보 아이디 받아오기 -->
			...
			<table style="padding-left: 10%;">
				<c:forEach var="comment" items="${comArr}">
					<tr>
						...
						<th><div id="del"><a href="/comment_del?id='${comment.id}'&con_no='${cvo.con_no}'&title='${cvo.title}'">삭제</a></div></th>
						</c:if>
					</tr>
				</c:forEach>
			</table>
