   ...
   <table>
      <tr>
         <th style="width: 1000px;">
            <div id="logo">
               <a href="main" id="logo">KG플릭스</a>
            </div>
         </th>
         <th style="width: 500px">
         <c:if test="${userInfo == null }"> <!-- userInfo는 로그인정보 userVO객체 -->
            <table id="table_header">
               <tr><th><div id="div_btn"><a href="/loginpage">로그인</a></div></th></tr>
               <tr><th><div id="div_btn"><a href="/joinpage">회원가입</a></div></th></tr>
            </table>
         </c:if>
         <c:if test="${userInfo != null }"> <!-- 유저정보 db출력 -->
            <table id="table_header">
               <tr><th colspan="3"><font id="logo">asw0711</font><font id="logo" style="color: white;"> 님 반갑습니다</font></th></tr>
